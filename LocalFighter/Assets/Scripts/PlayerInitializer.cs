    ...
    void Start()
    {
        ...
        for (int i = 0; i < playerConfigs.Length; i++)
        {
            ...
            if (playerConfigs[i].characterClass == 0)
            {
                ...
                var player = PlayerInput.Instantiate(fistPrefab, playerConfigs[i].PlayerIndex, playerConfigs[i].currentControlScheme, 0, playerConfigs[i].deviceId); //figure out how to get the device id
            ...
            if (playerConfigs[i].characterClass == 1)
            {
                ...
                var player = PlayerInput.Instantiate(thorPrefab, playerConfigs[i].PlayerIndex, playerConfigs[i].currentControlScheme, 0, playerConfigs[i].deviceId); //figure out how to get the device id
