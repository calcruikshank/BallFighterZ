...
public class MouseRightHand : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (transform.localPosition.x > 1.4f - .1f && playerScript.punchedRight && hitonefive == false)
        {
    ...
    void OnTriggerEnter2D(Collider2D hitInfo)
    {
        ...
        if (isBlockingOnlyWithLeft == true && playerScript.punchedRight)
        {
            damage = 1f;
            if (bluePlayer != null)
            {
